...
* Groupings were assigned when an entity represents a high-level disease grouping which cannot be easily targeted by drugs, for example [neurodegenerative disease](https://www.ebi.ac.uk/ols4/ontologies/mondo/classes/http%253A%252F%252Fpurl.obolibrary.org%252Fobo%252FMONDO_0005559?lang=en) 
* Clinically recognized label was assigned when an entity represents a disease which would be recognized by both a physician and a patient diagnosed with the disease, such as [Alzheimer disease](https://www.ebi.ac.uk/ols4/ontologies/mondo/classes/http%253A%252F%252Fpurl.obolibrary.org%252Fobo%252FMONDO_0004975?lang=en) 
