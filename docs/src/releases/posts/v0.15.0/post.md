...
- **Jaccard Accuracy Metric (JaM) Integration**: Added JaM to both the evaluation suite and run comparison pipeline, providing a new metric for assessing prediction quality and model performance across different runs. [#1993](https://github.com/everycure-org/matrix/pull/1993), [#2000](https://github.com/everycure-org/matrix/pull/2000)
