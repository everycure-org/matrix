...
* Build and Software: Provided free-of-charge under the MIT License.

* Documentation & downloadable build artifacts (GitHub/S3): Distributed under CC-BY 4.0 (link). Attribution requested as: RTX KG2 development team, github.com/RTXteam.

* Knowledge graph content: Inherits licenses from upstream sources (e.g., UMLS) that may restrict redistribution. Our CC-BY assertion applies only to creative products we generate (documentation, reports, graph formatting), not the underlying biomedical data.

* Accessibility**:** Public GitHub repo, S3 buckets, and APIs available; downstream users must comply with original source licenses when reusing KG2 content.
...
**Graph Version/ Release:** *\[auto-generated \- populated by build pipeline\]*

* Status: Continuously maintained academic/enterprise offering with public web explorer for neighborhoods; full graph access under license.

**Rationale for inclusion in EC KG:** Precision medicine–focused KG that links dozens of biomedical databases into a unified network. Demonstrated predictive signal for indications and translational analyses; aligns well with clinical and molecular use cases in repurposing.

**Citations**

* *Morris J.H. et al. The scalable precision medicine open knowledge engine (SPOKE): a massive knowledge graph of biomedical information. Bioinformatics. 2023 Feb;39(2):btad080. PMID: 36759942\. doi: 10.1093/bioinformatics/btad080.*

* *Baranzini S.E. et al. A Biomedical Open Knowledge Network Harnesses the Power of AI to Understand Deep Human Biology. AI Magazine. 2022 Mar;43(1):46-58. PMID: 36093122\. doi: 10.1002/aaai.12037.* 

* *Soman K., et al. Biomedical knowledge graph-optimized prompt generation for large language models. Bioinformatics. 2024 Sep;40(9). PMID: 39288310\. doi: 10.1093/bioinformatics/btae560.*

**Use Cases (drug repurposing relevance)**
...
* National Science Foundation \[[NSF\_2033569](https://academic.oup.com/bioinformatics/article/39/2/btad080/7033465)\]

* NIH/NCATS \[[NIH\_NOA\_1OT2TR003450](https://academic.oup.com/bioinformatics/article/39/2/btad080/7033465)\]

* [Marcus Program](https://academic.oup.com/bioinformatics/article/39/2/btad080/7033465) in Precision Medicine Innovation

**Licensing & Accessibility**

* [Build software](https://spoke.rbvi.ucsf.edu/license.html#:~:text=%2D%20no%20title%20specified,Ownership.): Provided free-of-charge under the MIT License.

* Documentation & downloadable build artifacts (GitHub/S3): Distributed under CC-BY 4.0. Attribution requested as: *‘RTX KG2 development team, github.com/RTXteam’*.
...
* **Status:** Commercial, continuously updated product; vendor reports frequent KG refreshes (weekly to annual components).

**Rationale for inclusion in EC KG:** Curated, AI‑driven knowledge graph spanning literature, trials, and databases with strong cause‑effect and biological relation coverage; useful for repurposing hypothesis generation, target/biomarker discovery, and evidence triage.

**Citations**

* [*Elsevier launches EmBiology*](https://www.elsevier.com/about/press-releases/elsevier-launches-embiology-to-deliver-the-unparalleled-insights-into-biological-activities-that-accelerate-drug-discovery?) *to deliver unparalleled insights into biological activities that accelerate drug discovery. Press release. April 19, 2023\. (Elsevier)*

* *EmBiology | Biological data structured for insights. [Product page](https://www.elsevier.com/products/embiology?). Elsevier.*

**Use Cases (drug repurposing relevance)**

* Used to i[mprove target and biomarker identification and prioritization](https://www.elsevier.com/about/press-releases/elsevier-launches-embiology-to-deliver-the-unparalleled-insights-into-biological-activities-that-accelerate-drug-discovery?) for drug discovery and development, by surfacing relationships between genes/proteins and disease biology via cause-and-effect relationships and filtering by concept types.  
...
**Funding / Supporting Program:** Proprietary product funded, developed and maintained by Elsevier.
...
**Rationale for inclusion in EC KG:** Disease‑centric, multimodal KG integrating \~20 resources and \>4M relationships, harmonized to enable precision‑medicine analyses. Frequently used as a benchmark and as input to downstream ML for repurposing and disease subtyping.

**Citations**

* *Chandak P. et al. Building a knowledge graph to enable precision medicine. Scientific Data. 2023;10(1):67. PMID: 36842935\.*
...
* Used to support drug-disease prediction by including an abundance of ‘indications’, ‘contradictions’, and ‘off-label use’ edges, enabling AI models to explore therapeutic action in less well-covered disease contexts. (Chandak et al. 2023\) (PMID: 36842935).   
* Used to improve coverage of rare and common diseases via connections across multiple biological scales (e.g. phenotypes, proteome perturbations, pathway nodes), increasing the graph’s utility for ML/AI models in predicting new repurposing hypotheses. (Chandak et al. 2023\) (PMID: 36842935).  
...
* National Science Foundation \[[Nos. IIS-2030459 and IIS-2033384](https://www.nature.com/articles/s41597-023-01960-3)\]   
* US Air Force Contract \[[No. FA8702-15-D-0001](https://www.nature.com/articles/s41597-023-01960-3)\]   
* [Harvard Data Science Initiative](https://www.nature.com/articles/s41597-023-01960-3)   
* [Awards](https://www.nature.com/articles/s41597-023-01960-3) from Amazon Research, Bayer Early Excellence in Science, AstraZeneca Research, and Roche Alliance with Distinguished Scientists

#### Licensing & Accessibility

* KG License: [CC0 1.0](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/IXA7BM)
* License: [MIT for code](https://github.com/mims-harvard/PrimeKG?tab=readme-ov-file#license); dataset licenses and data‑use terms specified on the [Dataverse record](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/IXA7BM) and by individual upstream resources
* Accessibility: Public download via Dataverse (raw KG and largest connected component); reuse governed by Dataverse/underlying source terms.
