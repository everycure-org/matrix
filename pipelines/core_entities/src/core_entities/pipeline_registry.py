...
def register_pipelines() -> dict[str, Pipeline]:
    ...
    pipelines = {
        ...
        "disease_categories": create_disease_mondo_pipeline() + create_disease_categories_pipeline(),
        "disease_umn": create_disease_mondo_pipeline() + create_disease_umn_pipeline(),
