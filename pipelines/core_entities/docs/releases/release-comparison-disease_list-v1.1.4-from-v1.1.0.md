...
**New Release:** `v1.1.4-disease_list`

**Base Release:** `v1.1.0-disease_list`

**New Release File:** `gs://mtrx-us-central1-hub-dev-storage/kedro/data/core-entities/disease_list/v1.1.4/03_primary/release/ec-disease-list.parquet`
...
| ID | Name | Old Value | New Value |
|----|------|-----------|-----------|
| `MONDO:0012398` | Achromatopsia 6 | `retinal cone dystrophy type 3A; retinal cone dystrophy 3A; retinal cone dystrophy 3` | `retinal cone dystrophy type 3A; retinal cone dystrophy 3A; RCD3A; ACHM6` |
| `MONDO:0005838` | Mansonelliasis | `Mansonellosis` | `infection by Dipetalonema perstans (disorder) [ambiguous]; infection by Dipetalonema perstans; in...` |
| `MONDO:0012727` | Kawasaki disease | `mucocutaneous lymph node syndrome; infantile polyarteritis nodosa; acute febrile mucocutaneous ly...` | `mucocutaneous lymph node syndrome; infantile polyarteritis nodosa; acute febrile mucocutaneous ly...` |
...
| `MONDO:0018147` | Macular telangiectasia type 3 | `occlusive idiopathic juxtafoveolar retinal telangiectasis` | `occlusive idiopathic juxtafoveolar retinal telangiectasis; idiopathic macular telangiectasia type 3` |
...
| `anatomical_id` | 22130 | 22127 |
| `anatomical_name` | 21999 | 21996 |
| `benign_malignant` | 22066 | 22063 |
| `core` | 22 | 22 |
| `deleted` | 0 | 0 |
...
| `new_id` | 22756 | 22753 |
| `precancerous` | 22 | 22 |
| `prevalence_experimental` | 15673 | 15670 |
| `prevalence_world` | 15538 | 15535 |
...
| `synonyms` | 4882 | 4879 |
| `txgnn` | 22 | 22 |
| `unmet_medical_need` | 15538 | 15535 |
