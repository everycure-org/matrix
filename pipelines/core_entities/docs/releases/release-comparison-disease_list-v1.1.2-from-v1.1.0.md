...
**New Release:** `v1.1.2-disease_list`

**Base Release:** `v1.1.0-disease_list`

**New Release File:** `gs://mtrx-us-central1-hub-dev-storage/kedro/data/core-entities/disease_list/v1.1.2/03_primary/release/ec-disease-list.parquet`
...
| `MONDO:0010483` | X-linked intellectual disability, cantagrel type | `mental retardation, X-linked type 98; intellectual disability, X-linked type 98; intellectual dev...` | `mental retardation, X-linked type 98; mental retardation, X-linked 98; intellectual disability, X...` |
