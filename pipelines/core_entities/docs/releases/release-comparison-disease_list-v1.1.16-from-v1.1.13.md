...
**New Release:** `v1.1.16-disease_list`

**Base Release:** `v1.1.13-disease_list`

**New Release File:** `gs://mtrx-us-central1-hub-dev-storage/kedro/data/core-entities/disease_list/v1.1.16/03_primary/release/ec-disease-list.parquet`
...
| `MONDO:0011671` | Huntington disease-like 2 | `psychiatric_disorder\|hereditary_disease\|nervous_system_disorder` | `hereditary_disease\|nervous_system_disorder` |
| `MONDO:0976127` | Muggenthaler-chowdhury-chioza syndrome | `hereditary_disease` | `syndromic_disease\|hereditary_disease` |
| `MONDO:0032572` | Cardiac, facial, and digital anomalies with dev... | `hereditary_disease` | `syndromic_disease\|hereditary_disease` |
| `MONDO:0006027` | Breast synovial sarcoma | `breast_disorder\|cancer_or_benign_tumor` | `breast_disorder\|hereditary_disease\|cancer_or_benign_tumor` |
...
| ID | Name | Old Value | New Value |
|----|------|-----------|-----------|
| `MONDO:0008921` | Carnosinemia | `metabolic_disease\|hereditary_disease` | `disease_by_etiologic_mechanism\|disease_by_developmental_or_physiological_process` |
| `MONDO:0958104` | Digenic alport syndrome | `inflammatory_disease\|hereditary_disease\|syndromic_disease\|urinary_system_disorder` | `disease_by_etiologic_mechanism\|disease_by_developmental_or_physiological_process\|disease_by_body_...` |
| `MONDO:0012273` | Autosomal recessive nonsyndromic hearing loss 48 | `nervous_system_disorder\|hereditary_disease\|auditory_system_disorder` | `disease_by_etiologic_mechanism\|disease_by_body_system_or_component` |
| `MONDO:0001094` | Residual stage of open angle glaucoma | `disorder_of_visual_system\|disorder_of_orbital_region` | `disease_by_body_system_or_component` |
| `MONDO:0019418` | X-linked intellectual disability-epilepsy-progr... | `disorder_of_development_or_morphogenesis\|nervous_system_disorder\|hereditary_disease\|syndromic_dis...` | `disease_by_etiologic_mechanism\|disease_by_developmental_or_physiological_process\|disease_by_body_...` |
...
| `MONDO:0020300` | `Autosomal dominant nocturnal frontal lobe epilepsy` | `obsolete autosomal dominant nocturnal frontal lobe epilepsy` |
...
| ID | Name | Old Value | New Value |
|----|------|-----------|-----------|
| `MONDO:0012273` | Autosomal recessive nonsyndromic hearing loss 48 | `autosomal recessive nonsyndromic hearing loss 48` | `autosomal recessive nonsyndromic hearing loss 48; Usher syndrome type 1J; USH1J` |
| `MONDO:0001094` | Residual stage of open angle glaucoma | `residual stage of open angle glaucoma; open-angle glaucoma residual stage` | `*None*` |
| `MONDO:0006744` | Endolymphatic hydrops | `labyrinthine hydrops` | `*None*` |
| `MONDO:0009297` | Familial renal glucosuria | `renal diabetes; familial renal glucosuria; SGLT2 deficiency; Renal Glycosuria` | `familial renal glucosuria; SGLT2 deficiency; Renal Glycosuria` |
| `MONDO:0003386` | Bladder clear cell adenocarcinoma | `urinary bladder clear cell adenocarcinoma; bladder mesonephric adenocarcinoma; bladder clear cell...` | `urinary bladder clear cell adenocarcinoma; bladder clear cell adenocarcinoma` |
