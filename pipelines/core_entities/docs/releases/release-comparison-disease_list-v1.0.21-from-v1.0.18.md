...
**New Release:** `v1.0.21-disease_list`

**Base Release:** `v1.0.18-disease_list`

**New Release File:** `gs://mtrx-us-central1-hub-dev-storage/kedro/data/core-entities/disease_list/v1.0.21/03_primary/release/ec-disease-list.parquet`
...
| `id` | 0 | 0 |
| `is_benign_tumour` | 15544 | 15544 |
| `is_glucose_dysfunction` | 15544 | 15544 |
| `is_infectious_disease` | 19 | 19 |
| `is_malignant_cancer` | 15544 | 15544 |
| `is_psychiatric_disease` | 15544 | 15544 |
| `level` | 1871 | 1871 |
