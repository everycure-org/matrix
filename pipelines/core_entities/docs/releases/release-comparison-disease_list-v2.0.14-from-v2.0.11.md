...
**New Release:** `v2.0.14-disease_list`

**Base Release:** `v2.0.11-disease_list`

**New Release File:** `gs://mtrx-us-central1-hub-dev-storage/kedro/data/core-entities/disease_list/v2.0.14/03_primary/release/ec-disease-list.parquet`
...
| ID | Name | Old Value | New Value |
|----|------|-----------|-----------|
| `MONDO:0008287` | Greig cephalopolysyndactyly syndrome | `["Greig's syndrome" 'Greig cephalosyndactyly syndrome'
 'Greig cephalopolysyndactyly syndrome' 'G...` | `['polysyndactyly with peculiar skull shape' "Greig's syndrome"
...
| `MONDO:0009746` | Hereditary sensory and autonomic neuropathy type 4 | `['insensitivity to pain, congenital, with anhidrosis'
 'hereditary sensory and autonomic neuropat...` | `['insensitivity to pain, congenital, with anhidrosis'
 'hereditary sensory and autonomic neuropat...` |
