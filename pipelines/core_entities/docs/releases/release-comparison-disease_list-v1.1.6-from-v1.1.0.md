...
**New Release:** `v1.1.6-disease_list`

**Base Release:** `v1.1.0-disease_list`

**New Release File:** `gs://mtrx-us-central1-hub-dev-storage/kedro/data/core-entities/disease_list/v1.1.6/03_primary/release/ec-disease-list.parquet`
...
| `MONDO:0009461` | Spermatogenic failure 5 | `spermatogenic failure type 5; spermatogenic failure 5; male infertility with large-headed, multif...` | `spermatogenic failure type 5; spermatogenic failure 5; male infertility with large-headed, multif...` |
