...
**New Release:** `v2.0.12-disease_list`

**Base Release:** `v2.0.11-disease_list`

**New Release File:** `gs://mtrx-us-central1-hub-dev-storage/kedro/data/core-entities/disease_list/v2.0.12/03_primary/release/ec-disease-list.parquet`
...
| `MONDO:0015005` | Epilepsy, early-onset, vitamin b6-dependent | `hereditary_disease\|metabolic_disease\|nervous_system_disorder` | `hereditary_disease\|metabolic_disease\|nervous_system_disorder\|nutritional_disorder` |
...
| ID | Name | Old Value | New Value |
|----|------|-----------|-----------|
| `MONDO:0007852` | Palmoplantar keratoderma-deafness syndrome | `['palmoplantar keratoderma-hearing loss syndrome'
 'palmoplantar hyperkeratosis-hearing loss synd...` | `['palmoplantar keratoderma-hearing loss syndrome'
 'palmoplantar keratoderma and sensorineural de...` |
...
| `MONDO:0014054` | Lymphoproliferative syndrome 2 | `['lymphoproliferative syndrome type 2'
 'lymphoproliferative syndrome caused by mutation in CD27'...` | `['lymphoproliferative syndrome caused by mutation in CD27'
 'lymphoproliferative syndrome 2' 'LPF...` |
| `MONDO:0007850` | Autosomal dominant keratitis-ichthyosis-hearing... | `['keratitis-ichthyosis -deafness syndrome'
 'KID syndrome, autosomal dominant']` | `['KID syndrome, autosomal dominant']` |
| `MONDO:0011827` | Patent ductus arteriosus | `['persistent patency of the arterial duct' 'patent ductus botalli'
 'patent ductus arteriosus' 'P...` | `['persistent patency of the arterial duct' 'patent ductus botalli'
 'patent ductus arteriosus fam...` |
