...
**New Release:** `v2.0.11-disease_list`

**Base Release:** `v2.0.6-disease_list`

**New Release File:** `gs://mtrx-us-central1-hub-dev-storage/kedro/data/core-entities/disease_list/v2.0.11/03_primary/release/ec-disease-list.parquet`
...
| `name` | 5 |
| `strategically_viable` | 5 |
| `strategically_viable_assigned_by` | 3 |
| `synonyms` | 89 |
...
| `MONDO:0000757` | Glucocorticoid-induced osteoporosis | `musculoskeletal_system_disorder\|hereditary_disease\|disorder_of_development_or_morphogenesis` | `musculoskeletal_system_disorder` |
...
| `MONDO:0000757` | Glucocorticoid-induced osteoporosis | `disease_by_etiologic_mechanism\|disease_by_developmental_or_physiological_process\|disease_by_body_...` | `disease_by_body_system_or_component` |
...
| ID | Name | Old Value | New Value |
|----|------|-----------|-----------|
| `MONDO:0014389` | Polyglucosan body myopathy 1 with or without im... | `False` | `True` |
| `MONDO:0003334` | Demyelinating polyneuropathy | `True` | `False` |
| `MONDO:0000192` | Polyglucosan body myopathy | `True` | `False` |
| `MONDO:0014526` | Polyglucosan body myopathy type 2 | `False` | `True` |
| `MONDO:0006702` | Chronic inflammatory demyelinating polyradiculo... | `False` | `True` |

#### `strategically_viable_assigned_by`

| ID | Name | Old Value | New Value |
|----|------|-----------|-----------|
| `MONDO:0014389` | Polyglucosan body myopathy 1 with or without im... | `not assigned` | `human` |
| `MONDO:0014526` | Polyglucosan body myopathy type 2 | `not assigned` | `human` |
| `MONDO:0006702` | Chronic inflammatory demyelinating polyradiculo... | `not assigned` | `human` |

#### `synonyms`

| ID | Name | Old Value | New Value |
|----|------|-----------|-----------|
| `MONDO:0011551` | Th-deficient dopa-responsive dystonia | `['tyrosine hydroxylase-deficient dopa-responsive dystonia'
 'dopa-responsive dystonia, autosomal ...` | `['tyrosine hydroxylase-deficient dopa-responsive dystonia'
 'dopa-responsive dystonia, autosomal ...` |
| `MONDO:0007915` | Systemic lupus erythematosus | `['systemic lupus erythematosus susceptibility to'
 'systemic lupus erythematosus (disease)' 'syst...` | `['systemic lupus erythematosus susceptibility to'
 'systemic lupus erythematosus (disease)' 'syst...` |
| `MONDO:0010805` | Bladder exstrophy | `['ectopia vesicae' 'classic exstrophy of the bladder'
 'bladder exstrophy (disease)' 'bladder exs...` | `['ectopia vesicae' 'classic exstrophy of the bladder'
 'bladder exstrophy (disease)' 'bladder exs...` |
| `MONDO:0014922` | Myofibrillar myopathy 7 | `['myopathy, myofibrillar, type 7' 'myopathy, myofibrillar, 7'
 'myofibrillar myopathy (disease) c...` | `['myopathy, myofibrillar, type 7' 'myopathy, myofibrillar, 7'
 'myofibrillar myopathy (disease) c...` |
| `MONDO:0009112` | Rhizomelic chondrodysplasia punctata type 2 | `['type 2 rhizomelic chondrodysplasia punctata'
