...
# fmt: on
def submit(username: str, namespace: str, run_name: str, release_name: str, pipeline: str, verbose: bool, dry_run: bool, from_nodes: List[str], is_test: bool):
...
def _submit(
    ...
    try:
        ...
        argo_template = build_argo_template(run_name, release_name, username, namespace, pipeline_obj, is_test=is_test, )
...
def build_argo_template(run_name: str, release_name: str, username: str, namespace: str, pipeline_obj: Pipeline, is_test: bool, default_execution_resources: Optional[ArgoResourceConfig] = None) -> str:
