...
from matrix.pipelines.moa_entity_resolution.pipeline import create_pipeline as create_moa_entity_resolution_pipeline
...
def register_pipelines() -> Dict[str, Pipeline]:
    ...
    pipelines = {
        ...
        "moa_entity_resolution": create_moa_entity_resolution_pipeline(),  # Run manually for DrugMechDB entity resolution
        ...
        "moa_extraction": create_moa_extraction_pipeline(),
    }
