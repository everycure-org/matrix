...
class ArgoResourceConfig(BaseModel):
    ...
    Attributes:
        ...
        ephemeral_storage_request (float): Ephemeral storage requested for the container in GB.
        ephemeral_storage_limit (float): Maximum ephemeral storage allowed for the container in GB.
    """
