        ...
        pipelines.append(
            pipeline(
                [
                    ...
                    ArgoNode(
                        func=nodes.generate_reporting_plots,
                        inputs=[
                            f"matrix_generation.fold_{n_cross_val_folds}.model_output.sorted_matrix_predictions@spark",
                            "integration.int.drug_list.nodes.norm@spark",
                            "integration.int.disease_list.nodes.norm@spark",
                            "params:matrix_generation.reporting_node.plots",
                        ],
                        output="matrix_generation.reporting.plots",
                        name="generate_reporting_plots",
                    ),
                    ArgoNode(
                        func=nodes.generate_reporting_tables,
                        inputs=[
                            f"matrix_generation.fold_{n_cross_val_folds}.model_output.sorted_matrix_predictions@spark",
                            "integration.int.drug_list.nodes.norm@spark",
                            "integration.int.disease_list.nodes.norm@spark",
                            "params:matrix_generation.reporting_node.tables",
                        ],
                        output="matrix_generation.reporting.tables",
