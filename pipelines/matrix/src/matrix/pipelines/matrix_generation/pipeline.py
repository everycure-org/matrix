        ...
        [
            ...
            node(
                ...
                inputs=[
                    ...
                    "params:evaluation.score_col_name",
                    "params:matrix_generation.stats_col_names",
                    "params:matrix_generation.metadata",
                ],
            ...
            node(
                ...
                inputs=[
                    f"matrix_generation.{model}.reporting.matrix_report",
                    "params:evaluation.score_col_name",
                    "params:matrix_generation.stats_col_names",
                    "params:matrix_generation.metadata",
                    "params:matrix_generation.run.workflow_id",
                    "params:matrix_generation.run.mlflow_run_name",
                    "params:matrix_generation.run.mlflow_link",
                    "params:matrix_generation.run.git_sha",
                    "params:matrix_generation.run.release_version",
                    "params:matrix_generation.run.rtx_kg2_version",
                    "params:matrix_generation.run.robokop_version",
                    "params:matrix_generation.run.ec_medical_team_version",
                    "params:matrix_generation.run.clinical_trial_data_version",
                    "params:matrix_generation.run.ec_drug_list_version",
                    "params:matrix_generation.run.ec_disease_list_version",
                ],
                outputs=[
