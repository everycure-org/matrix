...
from .utils import to_cpu, to_estimator_device
...
class ModelWrapper:
    ...
    def predict_proba(self, X, gpu_only=False):
        """Method for probability scores of the ModelWrapper.

        Args:
            X: input features
            gpu_only: If True, will attempt to run prediction on GPU if any estimator supports it.
