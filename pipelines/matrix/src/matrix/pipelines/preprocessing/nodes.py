...
def build_primekg_edges(edges: pl.DataFrame) -> pl.DataFrame:
    ...
    orig_df = (
        ...
        .with_columns(
            [
                ...
                .then(
                    pl.concat_str(
                        [pl.col("x_source"), pl.col("x_id").cast(pl.Utf8).str.pad_start(7, "0")],
                        separator=":",
                        ignore_nulls=True,
                    )
                )
        ...
        .with_columns(
            [
                ...
                .then(
                    pl.concat_str(
                        [pl.col("y_source"), pl.col("y_id").cast(pl.Utf8).str.pad_start(7, "0")],
                        separator=":",
                        ignore_nulls=True,
                    )
                )
    ...
    final_df = (
        pl.concat(
            [
                ...
                orig_df.filter(pl.col("predicate") == pl.lit("indication")).with_columns(
