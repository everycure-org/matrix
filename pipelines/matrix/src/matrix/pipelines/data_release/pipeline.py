...
def create_pipeline(**kwargs) -> Pipeline:
    ...
    return pipeline(
        [
            ...
            ArgoNode(
                func=lambda x: x,
                inputs=["modelling.model_input.filtered_edges"],
                outputs="data_release.prm.bigquery_edges",
                name="release_edges_to_bigquery",
            ),
            ArgoNode(
                func=lambda x: x,
                inputs=["modelling.model_input.filtered_nodes"],
            ...
            ArgoNode(
                func=ingest_edges,
                inputs=["data_release.prm.kg_nodes", "modelling.model_input.filtered_edges"],
