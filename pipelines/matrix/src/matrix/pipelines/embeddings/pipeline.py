    ...
    return pipeline(
        [
            ...
            node(
                ...
                inputs =["params:embeddings.topological.pecanpy_node2vec.num_walks", "params:embeddings.topological.pecanpy_node2vec.walk_length", "params:embeddings.topological.pecanpy_node2vec.feature_dim", "params:embeddings.topological.pecanpy_node2vec.p", "params:embeddings.topological.pecanpy_node2vec.q"],
