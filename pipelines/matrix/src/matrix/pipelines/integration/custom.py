...
def transform_ec_medical_team_nodes(nodes_df: DataFrame, biolink_categories_df: pd.DataFrame) -> DataFrame:
...
def transform_ec_medical_team_edges(edges_df: DataFrame) -> DataFrame:
