    ...
    generate_dynamic_pipeline_mapping(
        {
            ...
            "integration": [
                {"name": "rtx_kg2", "integrate_in_kg": True, "is_private": False, "is_core": False},
                {"name": "spoke", "integrate_in_kg": True, "is_private": True, "is_core": False},
                {"name": "embiology", "integrate_in_kg": True, "is_private": True, "is_core": False},
                {"name": "robokop", "integrate_in_kg": True, "is_private": False, "is_core": False},
                # {"name": "ec_medical_team", "integrate_in_kg": True, "is_core": False},
                ...
                {"name": "ground_truth", "integrate_in_kg": False, "has_nodes": False, "is_core": False},
                # {"name": "drugmech", "integrate_in_kg": False, "has_nodes": False, "is_core": False},
                {"name": "ec_clinical_trails", "integrate_in_kg": False, "is_core": False},
                {"name": "off_label", "integrate_in_kg": False, "has_nodes": False, "is_core": False},
            ],
            "modelling": {
