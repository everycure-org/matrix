...
def test_efficient_pairs(drugs: List[str], diseases: List[str], pairs: List[tuple[str]]):
    multi = 10
...
def test_efficient_pairs_abort(drugs: List[str], diseases: List[str], pairs: List[tuple[str]]):
    drugs = drugs[0:1]
