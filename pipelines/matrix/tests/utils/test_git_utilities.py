...
@pytest.mark.parametrize(
    ...
    [
        (["v0.1.0-matrix", "v0.2.0-matrix", "v0.2.5-matrix"], "0.2.0"),
        (["v2.1.2-matrix", "v1.2.3-matrix", "v1.3.2-matrix", "v1.1.2-matrix", "v1.1.1-matrix"], "2.1.2"),
        (
            ["v2.1.5-matrix", "v2.1.2-matrix", "v1.2.3-matrix", "v1.3.2-matrix", "v1.1.2-matrix", "1.1.1"],
            "2.1.2",
        ),
    ],
)
