...
def mock_context():
    ...
    mock_context.config_loader = {
        "globals": {
            ...
            "data_sources": {"robokop": {"version": "v1"}, "spoke": {"version": "v2"}},
        },
        "parameters": {
...
def test_extract_release_info(mock_context):
    ...
    expected_release_info = {
        ...
        "MLFlow": ("https://mlflow.platform.dev.everycure.org/#/experiments/555/runs/run123"),
        "Code": "https://github.com/everycure-org/matrix/tree/1.0.0",
        "NodeNorm Endpoint": "https://nodenorm.transltr.io/1.5/get_normalized_nodes",
        "KG dashboard": "https://data.dev.everycure.org/versions/1.0.0/evidence/",
    }
