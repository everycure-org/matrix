...
async function main() {
  ...
  try {
    ...
    console.log(`\n=== Success ===`);
    console.log(`Generated 4 SQL files from ${validReleases.length} releases and ${kgSources.length} KG sources`);
...
module.exports = { discoverReleases, discoverKGSources, generateReleaseTrendsSQL, generateKeyNodeTrendsSQL, generateKeyNodeAggregateSQL, generateKGPipelineMetricsSQL };
